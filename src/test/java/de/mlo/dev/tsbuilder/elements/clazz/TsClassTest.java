...
class TsClassTest {
    ...
    @Test
    void create_class_without_name(){
        TsClass clazz = new TsClass();
    ...
    @Test
    void merge_classes() {
        TsClass main = new TsClass("MainClass")
                .addComment("MainClass comment");

        TsClass firstNamelessClass = new TsClass()
                .addComment("Nameless comment");

        TsClass secondMainClass = new TsClass("MainClass")
                .addComment("Second main class comment");

        TsClass merged = main.merge(firstNamelessClass).merge(secondMainClass);
